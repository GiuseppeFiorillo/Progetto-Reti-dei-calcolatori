...
clientT : clientT.c green_pass.h addresses.h wrapped.h
	$(CC) $(CFLAGS) clientT.c -o clientT

clientS : clientS.c green_pass.h addresses.h wrapped.h
	$(CC) $(CFLAGS) clientS.c -o clientS

centro_vaccinale : centro_vaccinale.c green_pass.h addresses.h wrapped.h
	$(CC) $(CFLAGS) centro_vaccinale.c -o centro_vaccinale

serverV : serverV.c green_pass.h addresses.h wrapped.h
	$(CC) $(CFLAGS) serverV.c -o serverV

serverG : serverG.c green_pass.h addresses.h wrapped.h
